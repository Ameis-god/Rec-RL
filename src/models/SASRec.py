...
from models.base_rec import SeqRecBase
...
class SASRec(SeqRecBase):    
    ...
    def _define_model_layers(self): 
        ...
        self.position_embedding = nn.Embedding(self.max_seq_len+1, self.hidden_size) if self.use_pos_emb else None # +1 for consistent with ranking model
